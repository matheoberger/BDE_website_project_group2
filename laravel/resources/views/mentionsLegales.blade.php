            ...
            <div class="contenu">
                <div class="mentionsLegales__conteneur">
                    <div class="mentionsLegales__contenu">
                        <h1 class="mentionsLegales__title mentionsLegales--roboto">Mentions légales</h1>
                        <div class="CGV__navigation">
                            ...
                            <div>
                                <div>
                                    <h2>Editeur : Association BDE CESI Bordeaux</h2>
                                ...
                                <div class="list-group mentionsLegales__group">
                                    <a type="button" class="list-group-item list-group-item-action" href="CGV">
                                        Conditions générales de vente
                                    </a>
                                    <a type="button" class="list-group-item list-group-item-action" href="CGU">
                                        Conditions générales d'utilisation</a>
                                    <a type="button" class="list-group-item list-group-item-action"
                                        href="CGcookies">Utilisation
                                        des
                                        cookies</a>
                                    <a type="button" class="list-group-item list-group-item-action" href="CGRDP">Données
                                        personnelles</a>
                                </div>
                            </div>
                        </div>
